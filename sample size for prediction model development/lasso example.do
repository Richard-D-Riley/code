...
gen yes1 = .
replace yes1 = 0 if cslope > 1.1
replace yes1 = 0  if cslope < 0.9
...
gen yes2 = .
replace yes2 = 0 if cslope > 1.15
replace yes2 = 0  if cslope < 0.85
...
gen NBmodel_yes = .
replace NBmodel_yes = 1 if NBmodel_degrad_percent >= 90
...
nois summ NB_winner if NBmodel_yes != .
nois centile NB_winner, centile(2.5 50 97.5)

gen NB_winner_degrad = NB_winner - 0.407
nois summ NB_winner_degrad if NBmodel_yes != .
nois centile NB_winner_degrad, centile(2.5 50 97.5)

gen NB_winner_degrad_percent = (100*(NB_winner/0.407))
nois summ NB_winner_degrad_percent if NBmodel_yes != .
nois centile NB_winner_degrad_percent if NBmodel_yes != ., centile(2.5 50 97.5)
...
replace NB_winner_yes = 1 if NB_winner_degrad_percent >= 90

...
* fit logistic reg model with fixed set of predictors to the sample
...
matrix performance[`i',7] = (e(chi2) - e(df_m)) / e(chi2)

gen p_dev = invlogit(e(b)[1,11] + e(b)[1,1]*ageyrssd + e(b)[1,2]*ga_diag1sd + e(b)[1,3]*hist2sd + e(b)[1,4]*hist3sd + e(b)[1,5]*pcr1sd + e(b)[1,6]*serurea11sd + e(b)[1,7]*pcsd + e(b)[1,8]*sbpsd + e(b)[1,9]*trt_ahsd + e(b)[1,10]*trt_mgso4sd)
...
* only want the first row of results for a threshold of 0.5
use test, replace 
drop if _n > 1  
...
gen lin_pred = e(b)[1,11] + e(b)[1,1]*ageyrssd + e(b)[1,2]*ga_diag1sd + e(b)[1,3]*hist2sd + e(b)[1,4]*hist3sd + e(b)[1,5]*pcr1sd + e(b)[1,6]*serurea11sd + e(b)[1,7]*pcsd + e(b)[1,8]*sbpsd + e(b)[1,9]*trt_ahsd + e(b)[1,10]*trt_mgso4sd
...
gen model=(prob_`i'>z)*(outcome-((1-outcome)*z/(1-z))) 
sum model
...
mat colnames performance = sim_n cstat cslope NBmodel MAPE  strategy heuristic
...
replace NB_winner = `ENBall' if strategy == 1

nois summ NB_winner
nois centile NB_winner, centile(2.5 50 97.5)

gen NB_winner_degrad = NB_winner - `ENBmax'
nois summ NB_winner_degrad
nois centile NB_winner_degrad, centile(2.5 50 97.5)

gen NB_winner_degrad_percent = (100*(NB_winner/`ENBmax'))
